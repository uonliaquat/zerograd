...
#!/bin/bash
gcc -g -Iinclude src/main.c src/tensor.c src/safetensors.c src/layers/linear.c src/layers/embedding.c src/layers/transformer.c   src/layers/layer_norm.c  src/layers/self_attention_multi_head.c src/models/gpt.c -lm
