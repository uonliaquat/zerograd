...
//     self_attention_layer.W_query = linear_layer_init(embed_dim, embed_dim, bias, requires_grad, DTYPE_FP32);
//     self_attention_layer.W_key = linear_layer_init(embed_dim, embed_dim, bias, requires_grad, DTYPE_FP32);
//     self_attention_layer.W_value = linear_layer_init(embed_dim, embed_dim, bias, requires_grad, DTYPE_FP32);
