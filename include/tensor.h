...
void    tensor_vector_scale_(Tensor *inpput, Tensor *vector, Tensor *output);
...
void    tensor_vector_add_(Tensor *inpput, Tensor *vector, Tensor *output);
...
void    tensor_norm_(Tensor *x, Tensor *mean_var_tensor, float eps, Tensor *output);
